...
class ImportResultsView(SingleObjectMixin, FormView):
    ...
    def round_finder(self, name):
        round_ident = {
            ...
            "Metric IV": "metric_iv",
            "Metric V": "metric_v",
            "Long Metric I": "long_metric_i",
            "Long Metric II": "long_metric_ii",
            "Long Metric III": "long_metric_iii",
            "Long Metric IV": "long_metric_iv",
            "Long Metric V": "long_metric_v",
            "Long Metric VI": "long_metric_vi",
